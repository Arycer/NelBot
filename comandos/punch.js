...
module.exports = {
    ...
    execute: async function (interaction) {
        ...
        if (!objetoUsuario.puñetazo) objetoUsuario.puñetazo = {};

        objetoUsuario.puñetazo[usuarioMencionado.id] = objetoUsuario.puñetazo[usuarioMencionado.id] ? objetoUsuario.puñetazo[usuarioMencionado.id] + 1 : 1;
        objetoUsuario.save();

        const embed = new EmbedBuilder()
            .setTitle(`**${usuario.globalName}** ha pegado a **${usuarioMencionado.globalName}**`)
            .setDescription(`${usuario.globalName} le ha dado ${objetoUsuario.puñetazo[usuarioMencionado.id]} puñetazos a ${usuarioMencionado.globalName}`)
            .setImage(randomPat())
            .setColor(0xffb7c5);
